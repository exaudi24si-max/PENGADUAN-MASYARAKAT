            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item"><a class="nav-link text-white" href="#home-section">Beranda</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="#about-section">Tentang</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="#services-section">Layanan</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="#report-section">Laporan</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="#contact-section">Kontak</a></li>
                    </ul>
                </div>
            </div>
        </nav>
